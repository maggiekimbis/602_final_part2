...
Original file is located at
    https://colab.research.google.com/drive/1U_FzV748sYAxQ6-wzNFXSiMtWoCTY_FN
"""
...
keys = ['3GKMN56B0K275TJZ', 'JCQFVNBK3U8QMZ0T', 'P1Y9WYCX6JNW4N1M', 'HP94RXLQOYEWVCMZ']
MY_KEY = "3GKMN56B0K275TJZ"
...
def plot_graph(dataset):
    fig = px.line(dataset, x=dataset.index[::-1], y=['open', 'high', 'low', 'close'],
                  labels={'value': 'Price', 'variable': 'Type'},
                  title=f'{selected_stock} Stock Prices',
                  line_shape='linear')
    fig.update_xaxes(title_text='Time scale')
    return fig
